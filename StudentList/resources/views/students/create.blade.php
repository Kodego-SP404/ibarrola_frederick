...
<header class="mt-5 max-w-lg mx-auto">
   <a href="#">
      <h1 class="mt-20 text-4xl font-bold text-white text-center"> Add New Student</h1>
   </a>
</header>
   ...
   <section class="mt-10">
      <form action="/add/student" method="POST" class="flex flex-col">
         ...
         <div class="mb-6 pt-3 rounded bg-gray-200">
            ...
            <input type="number" name="age" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-amber-400 px-3" autocomplete="off" value={{old('age')}}>
            @error('age')
            <p class="text-red-500 text-xs mt-2">
                {{$message}}
            </p>
         ...
         <div class="mb-6 pt-3 rounded bg-gray-200">
            ...
            <input type="email" name="email" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-amber-400 px-3" autocomplete="off" value={{old('email')}}>
            @error('first_name')
            <p class="text-red-500 text-xs mt-2">
                {{$message}}
            </p>
         ...
         <button type="submit" class="bg-amber-400 hover:bg-amber-300 text-gray-700 font-bold py-2 rounded shadow-lg hover:shadow-xl transitionduration-200" type="submit">Add New</button>
      </form>
   </section>
</main>
